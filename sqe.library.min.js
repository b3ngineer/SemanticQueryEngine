...
b.length)return!1;for(var l=0;l<a.length;l++)if(a[l]!==b[l])return!1;return!0};a.prototype.executeQuery=function(a){if("undefined"===typeof a)throw Error("Cannot execute query on undefined state");for(var b=[],l=[],d=0,g=a.length;d<g;d++)for(var f=this.getTermId(a[d]),e=0,m=this._rules.length;e<m;e++){if("undefined"===typeof b[e])b[e]=0;else if(!1===b[e])continue;var h=this._rules[e].length,k=this._rules[e][h-2];b[e]!=k&&(h=f[1],k=this._rules[e][f[0]],"undefined"===typeof k||"undefined"===typeof k[h]||
!(k[h]instanceof Array)?b[e]=!1:b[e]++)}d=0;for(a=b.length;d<a;d++)h=this._rules[d].length,k=this._rules[d][h-2],b[d]===k&&l.push(this._rules[d][h-1]);"function"===typeof this._conflictStrategy&&this._conflictStrategy.apply(l,null);return l};this._searchModel=new a}SemanticQueryEngine.prototype._name="SemanticQueryEngine";
